...
@Target({})
public @interface ScaleIOVolumeSource {

  String fsType() default "";

  String gateway() default "";

  String protectionDomain() default "default";
  ...
  StorageMode storageMode() default StorageMode.thin;

  String storagePool() default "default";
